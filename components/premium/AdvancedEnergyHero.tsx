    ...
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 pt-20 pb-32">
        ...
        >
          ...
          >
            <span className="text-green-400">"At GREAN WORLD</span> Energy
            Technology, we don't just sell solar — we deliver advanced energy
        ...
        <div className="relative max-w-5xl mx-auto mt-10 h-[300px] md:h-[400px]">
          ...
          >
            <div className="relative w-[180px] h-[220px] bg-slate-800/80 rounded-lg border border-teal-900 shadow-lg flex flex-col">
              ...
              {/* Inverter Label */}
              <div className="text-center py-2 text-teal-400 font-medium tracking-widest">
                INVERTER
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative flex flex-col items-center">
              ...
              <div className="text-center mt-4 text-teal-400 font-medium">
                Smart Lighting
              </div>
            </div>
          </motion.div>
