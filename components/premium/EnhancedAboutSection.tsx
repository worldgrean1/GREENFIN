          ...
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            >
              ...
              <p className="text-gray-300">
                ...
                through innovative solutions that make clean power accessible to
                everyone.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-300">
                A world powered by 100% renewable energy, where sustainable
                solutions drive economic growth and environmental preservation.
              </p>
            </motion.div>
          </motion.div>
            ...
            >
              <div className="w-full h-full bg-gray-800/50 backdrop-blur-sm rounded-xl flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <p className="text-gray-300">
                    Serving communities worldwide with sustainable energy
                    solutions
                  </p>
                </div>
              </div>
