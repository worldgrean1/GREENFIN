            ...
            {[
              {
                title: 'Innovation',
                description:
                  'Cutting-edge technology driving sustainable energy solutions',
                icon: '🚀',
              },
              {
                title: 'Sustainability',
                description:
                  'Committed to reducing carbon footprint through green energy',
                icon: '🌱',
              },
              {
                title: 'Reliability',
                description:
                  'Dependable energy solutions for homes and businesses',
                icon: '⚡',
              },
            ].map((feature, index) => (
              <motion.div
